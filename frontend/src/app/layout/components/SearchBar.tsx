    ...
    <div className={`relative w-full ${className}`} ref={dropdownRef}>
      <div className="relative">
        ...
        <input
          ...
          className="w-full py-2 px-10 bg-fk-white text-gray-900 border-0 rounded-full hover:shadow-lg hover:ring-1 hover:ring-gray-400 focus:outline-none focus:ring-1 focus:ring-fk-lila"
        />
        {query && (
          <button
            onClick={clearSearch}
